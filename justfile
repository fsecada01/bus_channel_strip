...
# Install VST3 + CLAP to system plugin directories (requires admin)
install:
    powershell -NoProfile -ExecutionPolicy Bypass -File scripts\install.ps1 -Vst3Dir "{{VST3_DIR}}" -ClapDir "{{CLAP_DIR}}"
