...
:::tip[Quick Start]
For transparent mix-bus glue: set Compress to **0.3**, Output to **0.6**, Dry/Wet to **0.35**. The ButterComp2 works best with subtle settings — push Compress past 0.7 only for deliberate NY-style parallel saturation.
:::
...
- [Techniques & Presets](/bus_channel_strip/presets/techniques/) — NY parallel compression presets
