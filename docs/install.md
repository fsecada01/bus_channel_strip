...
The recommended path for most users. Go to the [latest release](https://github.com/fsecada01/bus_channel_strip/releases/latest) and download the archive for your platform.
...
| **Logic Pro** | ✓ | — | VST3; AU not yet supported |
| **Ableton Live** | ✓ | — | VST3 |
