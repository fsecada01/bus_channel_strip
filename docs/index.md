...
> Built with [NIH-Plug](https://github.com/robbert-vdh/nih-plug), [Airwindows DSP](https://github.com/airwindows/airwindows), and [vizia](https://vizia.dev/) · GPL-3.0-or-later · v0.3.0
...
All six modules are **reorderable** via drag-to-swap handles in the GUI. Each module has an individual bypass switch and is fully automatable.
...
| [**Pultec EQ**](modules/pultec.md) | EQP-1A style passive tube EQ | Simultaneous boost/cut, tube warmth |
