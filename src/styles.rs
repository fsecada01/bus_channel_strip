...
/* Near-white so the brand name stays legible against the dark chassis
   background, not just against the brass fill (see commit history for
   the near-black color this replaced). */
.chassis-brand {
    font-size: 24px;
    font-weight: 800;
    color: #f0ead6;
